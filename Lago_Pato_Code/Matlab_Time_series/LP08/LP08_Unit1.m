...
load LP08_U1_LnFe_Mn.txt
series1 = LP08_U1_LnFe_Mn(all(~isnan(LP08_U1_LnFe_Mn),2),:);
load LP08_U1_LnMn_Ti.txt
series2 = LP08_U1_LnMn_Ti(all(~isnan(LP08_U1_LnMn_Ti),2),:);

% Create series labels and x, y axis labels for all plots
seriesname1={'LP08 U1 Ln(Fe/Mn)'};
ylbl1 = {'LP08 U1: Ln(Fe/Mn)'};
xlbl1 = {'Age (cal yr BP)'};
seriesname2={'LP08 U1 Ln(Mn/Ti)'};
ylbl2 = {'LP08: Ln(Mn/Ti)'};
xlbl2 = {'Age (cal yr BP)'};
ylblspecial1 = {'LP08 U1: Ln(Fe/Mn) (blue), LP08 U1: Ln(Mn/Ti) (orange)'};

%% DATASET 2
% Series 1 and remove NaN row
%load LP08_U1_LnFe_Mn.txt
%series1 = LP08_U1_LnFe_Mn(all(~isnan(LP08_U1_LnFe_Mn),2),:);
%load LP08_U1_LnBr_Ti.txt
%series2 = LP08_U1_LnBr_Ti(all(~isnan(LP08_U1_LnBr_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 U1 Ln(Fe/Mn)'};
%ylbl1 = {'LP08: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 U1 Ln(Br/Ti)'};
%ylbl2 = {'LP08 U1: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 U1a: Ln(Fe/Mn) (blue), LP08 U1: Ln(Br/Ti) (orange)'};

%% DATASET 3
% Series 1
%load LP08_U1_LnMn_Ti.txt
%series1 = LP08_U1_LnMn_Ti(all(~isnan(LP08_U1_LnMn_Ti),2),:);
%load LP08_U1_LnBr_Ti.txt
%series2 = LP08_U1_LnBr_Ti(all(~isnan(LP08_U1_LnBr_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 U1 Ln(Mn/Ti)'};
%ylbl1 = {'LP08: Ln(Mn/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 U1 Ln(Br/Ti)'};
%ylbl2 = {'LP08 U1a: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 U1a: Ln(Mn/Ti) (blue), LP08 U1a: Ln(Br/Ti) (orange)'};

%% DATASET 4
% Series 1
%load LP08_U1_LnFe_Mn.txt
%series1 = LP08_U1_LnFe_Mn(all(~isnan(LP08_U1_LnFe_Mn),2),:);
%load LP08_U1_LnInc_Coh.txt
%series2 = LP08_U1_LnInc_Coh(all(~isnan(LP08_U1_LnInc_Coh),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 U1 Ln(Fe/Mn)'};
%ylbl1 = {'LP08 U1: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 U1 Ln(Inc/Coh)'};
%ylbl2 = {'LP08 U1: Ln(Inc/Coh)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 U1: Ln(Fe/Mn) (blue), LP08 U1: Ln(Inc/Coh) (orange)'};

%% DATASET 5
% Series 1
%load LP08_U1_LnMn_Ti.txt
%series1 = LP08_U1_LnMn_Ti(all(~isnan(LP08_U1_LnMn_Ti),2),:);
%load LP08_U1_LnCa_Ti.txt
%series2 = LP08_U1_LnCa_Ti(all(~isnan(LP08_U1_LnCa_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 U1 Ln(Mn/Ti)'};
%ylbl1 = {'LP08 U1: Ln(Mn/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 U1 Ln(Ca/Ti)'};
%ylbl2 = {'LP08 U1: Ln(Ca/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 U1: Ln(Mn/Ti) (blue), LP08 U1: Ln(Ca/Ti) (orange)'};

%% DATASET 6
% Series 1
%load LP08_U1_LnBr_Ti.txt
%series1 = LP08_U1_LnBr_Ti(all(~isnan(LP08_U1_LnBr_Ti),2),:);
%load LP08_U1_LnInc_Coh.txt
%series2 = LP08_U1_LnInc_Coh(all(~isnan(LP08_U1_LnInc_Coh),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 U1 Ln(Br/Ti)'};
%ylbl1 = {'LP08 U1: Ln(Br/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 U1 Ln(Inc/Coh)'};
%ylbl2 = {'LP08 U1: Ln(Inc/Coh)'};
%xlbl2 = {'Age (cal yr BP)'};

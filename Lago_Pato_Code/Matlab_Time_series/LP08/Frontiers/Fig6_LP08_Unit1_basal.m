...
addpath('/Users/Steve/Dropbox/BAS/Data/MATLAB/Matlab_projects/PeakAnalysis/Data/LP08/Frontiers')
...
% Series 1 & 2 and remove NaN rows - Ln ratio datasets
load LP08_U1basal_Fe_Mn_M1H.txt
series1 = LP08_U1basal_Fe_Mn_M1H(all(~isnan(LP08_U1basal_Fe_Mn_M1H),2),:);
load LP08_U1basal_Mn_Ti_M1H.txt
series2 = LP08_U1basal_Mn_Ti_M1H(all(~isnan(LP08_U1basal_Mn_Ti_M1H),2),:);
...
% check factor values - find replace all for eg 100 years rather than use
% factor 3-6 replacement
factor1 = 10
factor2 = 10

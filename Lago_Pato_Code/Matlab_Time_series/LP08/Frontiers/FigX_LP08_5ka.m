...
addpath('/Users/Steve/Dropbox/BAS/Data/MATLAB/Matlab_projects/PeakAnalysis/Data/LP08')
addpath('/Users/Steve/Dropbox/BAS/Data/MATLAB/Matlab_projects/PeakAnalysis/Code')
addpath('/Users/Steve/Dropbox/BAS/Data/MATLAB/Matlab_projects/PeakAnalysis/Code/LP08')
...
% Series 1 & 2 and remove NaN row
%load LP08_5k_LnFe_Mn.txt
%series1 = LP08_5k_LnFe_Mn(all(~isnan(LP08_5k_LnFe_Mn),2),:);
%load LP08_5k_LnMn_Ti.txt
%series2 = LP08_5k_LnMn_Ti(all(~isnan(LP08_5k_LnMn_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 5ka Ln(Fe/Mn)'};
%ylbl1 = {'LP08 5ka: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 5ka Ln(Mn/Ti)'};
%ylbl2 = {'LP08: Ln(Mn/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 5ka: Ln(Fe/Mn) (blue), LP08 5ka: Ln(Mn/Ti) (orange)'};

%% DATASET 2
% Series 1 & 2 and remove NaN row
%load LP08_5k_LnFe_Mn.txt
%series1 = LP08_5k_LnFe_Mn(all(~isnan(LP08_5k_LnFe_Mn),2),:);
%load LP08_5k_LnBr_Ti.txt
%series2 = LP08_5k_LnBr_Ti(all(~isnan(LP08_5k_LnBr_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 5ka Ln(Fe/Mn)'};
%ylbl1 = {'LP08: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 5ka Ln(Br/Ti)'};
%ylbl2 = {'LP08 5ka: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 5ka: Ln(Fe/Mn) (blue), LP08 5ka: Ln(Br/Ti) (orange)'};

%% DATASET 3
% Series 1 & 2 and remove NaN row
%load LP08_5k_LnMn_Ti.txt
%series1 = LP08_5k_LnMn_Ti(all(~isnan(LP08_5k_LnMn_Ti),2),:);
%load LP08_5k_LnBr_Ti.txt
%series2 = LP08_5k_LnBr_Ti(all(~isnan(LP08_5k_LnBr_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 5ka Ln(Mn/Ti)'};
%ylbl1 = {'LP08: Ln(Mn/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 5ka Ln(Br/Ti)'};
%ylbl2 = {'LP08 5ka: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 5ka: Ln(Mn/Ti) (blue), LP08 5ka: Ln(Br/Ti) (orange)'};

%% DATASET 4
% Series 1
%load LP08_5k_LnFe_Mn.txt
%series1 = LP08_5k_LnFe_Mn(all(~isnan(LP08_5k_LnFe_Mn),2),:);
%load LP08_5k_LnInc_Coh.txt
%series2 = LP08_5k_LnInc_Coh(all(~isnan(LP08_5k_LnInc_Coh),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 5k Ln(Fe/Mn)'};
%ylbl1 = {'LP08 5k: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 5k Ln(Inc/Coh)'};
%ylbl2 = {'LP08 5k: Ln(Inc/Coh)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 5k: Ln(Fe/Mn) (blue), LP08 5k: Ln(Inc/Coh) (orange)'};

%% DATASET 5
% Series 1
%load LP08_5k_LnMn_Ti.txt
%series1 = LP08_5k_LnMn_Ti(all(~isnan(LP08_5k_LnMn_Ti),2),:);
%load LP08_5k_LnCa_Ti.txt
%series2 = LP08_5k_LnCa_Ti(all(~isnan(LP08_5k_LnCa_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 5k Ln(Mn/Ti)'};
%ylbl1 = {'LP08 5k: Ln(Mn/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 5k Ln(Ca/Ti)'};
%ylbl2 = {'LP08 5k: Ln(Ca/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 5k: Ln(Mn/Ti) (blue), LP08 5k: Ln(Ca/Ti) (orange)'};

%% DATASET 6
% Series 1
load LP08_5k_LnBr_Ti.txt
series1 = LP08_5k_LnBr_Ti(all(~isnan(LP08_5k_LnBr_Ti),2),:);
load LP08_5k_LnInc_Coh.txt
series2 = LP08_5k_LnInc_Coh(all(~isnan(LP08_5k_LnInc_Coh),2),:);

% Create series labels and x, y axis labels for all plots
seriesname1={'LP08 5k Ln(Br/Ti)'};
ylbl1 = {'LP08 5k: Ln(Br/Ti)'};
xlbl1 = {'Age (cal yr BP)'};
seriesname2={'LP08 5k Ln(Inc/Coh)'};
ylbl2 = {'LP08 5k: Ln(Inc/Coh)'};
xlbl2 = {'Age (cal yr BP)'};
ylblspecial1 = {'LP08 5k: Ln(Br/Ti) (blue), LP08 5k: Ln(Inc/Coh) (orange)'};
...
output3 = [x1reshape, y1reshape, y1normreshape, y2reshape, y2normreshape, y2s ,y2sl, y2sln, y4s, y4sl, y4sln];

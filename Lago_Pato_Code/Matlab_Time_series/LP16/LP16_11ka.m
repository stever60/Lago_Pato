...
%load LP16_11k_LnFe_Mn.txt
%series1 = LP16_11k_LnFe_Mn(all(~isnan(LP16_11k_LnFe_Mn),2),:);
%load LP16_11k_LnMn_Ti.txt
%series2 = LP16_11k_LnMn_Ti(all(~isnan(LP16_11k_LnMn_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP16 11k Ln(Fe/Mn)'};
%ylbl1 = {'LP16 11k: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP16 11k Ln(Mn/Ti)'};
%ylbl2 = {'LP16 11k: Ln(Mn/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP16 11k: Ln(Fe/Mn) (blue), LP16 11k: Ln(Mn/Ti) (orange)'};

%% DATASET 2
% Series 1 and remove NaN row
%load LP16_11k_LnFe_Mn.txt
%series1 = LP16_11k_LnFe_Mn(all(~isnan(LP16_11k_LnFe_Mn),2),:);
%load LP16_11k_LnBr_Ti.txt
%series2 = LP16_11k_LnBr_Ti(all(~isnan(LP16_11k_LnBr_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP16 11k Ln(Fe/Mn)'};
%ylbl1 = {'LP16 11k: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP16 11k Ln(Br/Ti)'};
%ylbl2 = {'LP16 11k: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP16 11ka: Ln(Fe/Mn) (blue), LP16 11k: Ln(Br/Ti) (orange)'};

%% DATASET 3
% Series 1
%load LP16_11k_LnMn_Ti.txt
%series1 = LP16_11k_LnMn_Ti(all(~isnan(LP16_11k_LnMn_Ti),2),:);
%load LP16_11k_LnBr_Ti.txt
%series2 = LP16_11k_LnBr_Ti(all(~isnan(LP16_11k_LnBr_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP16 11k Ln(Mn/Ti)'};
%ylbl1 = {'LP16 11k: Ln(Mn/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP16 11k Ln(Br/Ti)'};
%ylbl2 = {'LP16 11k: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP16 11k: Ln(Mn/Ti) (blue), LP16 11k: Ln(Br/Ti) (orange)'};

%% DATASET 4
% Series 1
%load LP16_11k_LnFe_Mn.txt
%series1 = LP16_11k_LnFe_Mn(all(~isnan(LP16_11k_LnFe_Mn),2),:);
%load LP16_11k_LnInc_Coh.txt
%series2 = LP16_11k_LnInc_Coh(all(~isnan(LP16_11k_LnInc_Coh),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP16 11k Ln(Fe/Mn)'};
%ylbl1 = {'LP16 11k: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP16 11k Ln(Inc/Coh)'};
%ylbl2 = {'LP16 11k: Ln(Inc/Coh)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP16 11k: Ln(Fe/Mn) (blue), LP16 11k: Ln(Inc/Coh) (orange)'};

%% DATASET 5
% Series 1
%load LP16_11k_LnMn_Ti.txt
%series1 = LP16_11k_LnMn_Ti(all(~isnan(LP16_11k_LnMn_Ti),2),:);
%load LP16_11k_LnCa_Ti.txt
%series2 = LP16_11k_LnCa_Ti(all(~isnan(LP16_11k_LnCa_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP16 11k Ln(Mn/Ti)'};
%ylbl1 = {'LP16 11k: Ln(Mn/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP16 11k Ln(Ca/Ti)'};
%ylbl2 = {'LP16 11k: Ln(Ca/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP16 11k: Ln(Mn/Ti) (blue), LP16 11k: Ln(Ca/Ti) (orange)'};

%% DATASET 6
% Series 1
load LP16_11k_LnBr_Ti.txt
series1 = LP16_11k_LnBr_Ti(all(~isnan(LP16_11k_LnBr_Ti),2),:);
load LP16_11k_LnInc_Coh.txt
series2 = LP16_11k_LnInc_Coh(all(~isnan(LP16_11k_LnInc_Coh),2),:);

% Create series labels and x, y axis labels for all plots
seriesname1={'LP16 11k Ln(Br/Ti)'};
ylbl1 = {'LP16 11k: Ln(Br/Ti)'};
xlbl1 = {'Age (cal yr BP)'};
seriesname2={'LP16 11k Ln(Inc/Coh)'};
ylbl2 = {'LP16 11k: Ln(Inc/Coh)'};
xlbl2 = {'Age (cal yr BP)'};

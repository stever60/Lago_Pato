...
%series2 = LP08_10k_LnMn_Ti(all(~isnan(LP08_10k_LnMn_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 10k Ln(Fe/Mn)'};
%ylbl1 = {'LP08 10k: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 10k Ln(Mn/Ti)'};
%ylbl2 = {'LP08 10k: Ln(Mn/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 10k: Ln(Fe/Mn) (blue), LP08 10k: Ln(Mn/Ti) (orange)'};
...
%series2 = LP08_10k_LnBr_Ti(all(~isnan(LP08_10k_LnBr_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 10k Ln(Fe/Mn)'};
%ylbl1 = {'LP08 10k: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 10k Ln(Br/Ti)'};
%ylbl2 = {'LP08 10k: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 10ka: Ln(Fe/Mn) (blue), LP08 10k: Ln(Br/Ti) (orange)'};
...
%ylbl2 = {'LP08 10k: Ln(Br/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 10k: Ln(Mn/Ti) (blue), LP08 10k: Ln(Br/Ti) (orange)'};
...
%series2 = LP08_10k_LnInc_Coh(all(~isnan(LP08_10k_LnInc_Coh),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 10k Ln(Fe/Mn)'};
%ylbl1 = {'LP08 10k: Ln(Fe/Mn)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 10k Ln(Inc/Coh)'};
%ylbl2 = {'LP08 10k: Ln(Inc/Coh)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 10k: Ln(Fe/Mn) (blue), LP08 10k: Ln(Inc/Coh) (orange)'};
...
%series2 = LP08_10k_LnCa_Ti(all(~isnan(LP08_10k_LnCa_Ti),2),:);

% Create series labels and x, y axis labels for all plots
%seriesname1={'LP08 10k Ln(Mn/Ti)'};
%ylbl1 = {'LP08 10k: Ln(Mn/Ti)'};
%xlbl1 = {'Age (cal yr BP)'};
%seriesname2={'LP08 10k Ln(Ca/Ti)'};
%ylbl2 = {'LP08 10k: Ln(Ca/Ti)'};
%xlbl2 = {'Age (cal yr BP)'};
%ylblspecial1 = {'LP08 10k: Ln(Mn/Ti) (blue), LP08 10k: Ln(Ca/Ti) (orange)'};
...
ylbl2 = {'LP08 10k: Ln(Inc/Coh)'};
xlbl2 = {'Age (cal yr BP)'};
ylblspecial1 = {'LP08 10k: Ln(Br/Ti) (blue), LP08 10k: Ln(Inc/Coh) (orange)'};
